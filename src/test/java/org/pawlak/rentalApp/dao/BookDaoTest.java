...
class BookDaoTest {
    ...
    void shouldInsertAndUpdateBook() {
        Book book = new Book(0, "Test Title", "Author Name", "Description", 2021, 250, BookGenres.FANTASY, true);
    ...
    void shouldGetAvailableBooks() {
        Book book1 = new Book(0, "Available Book", "Author A", "Desc A", 2020, 100, BookGenres.FANTASY, true);
        Book book2 = new Book(0, "Unavailable Book", "Author B", "Desc B", 2019, 150, BookGenres.SCIENCE_FICTION, false);
    ...
    void shouldFindAvailableBooksByGenre() {
        Book book1 = new Book(0, "Fantasy Book 1", "Author X", "Desc X", 2018, 300, BookGenres.FANTASY, true);
        Book book2 = new Book(0, "Fantasy Book 2", "Author Y", "Desc Y", 2017, 200, BookGenres.FANTASY, false);
        Book book3 = new Book(0, "Drama Book", "Author Z", "Desc Z", 2016, 150, BookGenres.DRAMA, true);
